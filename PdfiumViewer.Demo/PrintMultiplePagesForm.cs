...
namespace PdfiumViewer.Demo
{
    public partial class PrintMultiplePagesForm : Form
    {
        ...
        private void _acceptButton_Click(object sender, EventArgs e)
        {
            ...
            {
                var settings = new PdfPrintSettings(_viewer.DefaultPrintMode, new PdfPrintMultiplePages(horizontal, vertical, _horizontalOrientation.Checked ? PdfOrientation.Horizontal : PdfOrientation.Vertical, margin));
