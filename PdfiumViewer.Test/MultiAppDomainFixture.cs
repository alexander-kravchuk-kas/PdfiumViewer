...
namespace PdfiumViewer.Test
{
    ...
    public class MultiAppDomainFixture
    {
        ...
        private class Runner : IDisposable
        {
            ...
            public Runner()
            {
                _appDomain = AppDomain.CreateDomain("Unit test", AppDomain.CurrentDomain.Evidence, new AppDomainSetup
                                                                                                   {
            ...
            public void Run()
            {
                var script = (Script)_appDomain.CreateInstanceAndUnwrap(typeof(Script).Assembly.FullName, typeof(Script).FullName);
