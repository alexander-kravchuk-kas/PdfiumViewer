...
[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        ...
        /// <summary>
        /// Opens a document using a .NET Stream. Allows opening huge PDFs without loading them into memory first.
        /// </summary>
        ...
        /// <param name="id">
        /// Retrieves an IntPtr to the COM object for the Stream. The caller must release this with Marshal.Release
        /// prior to Disposing the Stream.
        /// </param>
