    ...
    public class CustomScrollControl : Control
    {
        ...
        private void SetDisplayRectLocation(int x, int y, bool preserveContents)
        {
            ...
            if(((xDelta != 0) || (yDelta != 0)) && IsHandleCreated && preserveContents)
            {
                ...
                NativeMethods.ScrollWindowEx(new HandleRef(this, Handle), xDelta, yDelta, IntPtr.Zero, ref rcClip, IntPtr.Zero, ref rcUpdate, NativeMethods.SW_INVALIDATE | NativeMethods.SW_SCROLLCHILDREN);
            }
        ...
        private void WmHScroll(ref System.Windows.Forms.Message m)
        {
            ...
            switch(NativeMethods.Util.LOWORD(m.WParam))
            {
                ...
                case NativeMethods.SB_THUMBTRACK:
                    SetDisplayRectLocation(-ScrollThumbPosition(NativeMethods.SB_HORZ), _displayRect.Y);
                    SyncScrollbars();
                    break;
        ...
        {
            var e = new SetCursorEventArgs(PointToClient(Cursor.Position), (HitTest)(m.LParam.ToInt32() & 0xffff));
            OnSetCursor(e);
        ...
        private void WmVScroll(ref System.Windows.Forms.Message m)
        {
            ...
            switch(NativeMethods.Util.LOWORD(m.WParam))
            {
                case NativeMethods.SB_THUMBPOSITION:
                case NativeMethods.SB_THUMBTRACK:
                    SetDisplayRectLocation(_displayRect.X, -ScrollThumbPosition(NativeMethods.SB_VERT));
                    SyncScrollbars();
                    break;
